...
public class UserManager  implements IUserManager{
	...
	public UserManager() {
		...
		try {
			addUser(defaultUser);
			System.out.println("[UserManager]Default user tapestry/password has been added.");
	...
	public void addUser(User user)
		...
		if (user != null) {
			...
			Action uploadPhoto = new Action();
			uploadPhoto.setLibelle("Upload photo");
			uploadPhoto.setUrl("uploadPhoto");
			if (user.getAdminRigths()) {
				admins.add(user);
			} else {
				nonAdmins.add(user);
			}
