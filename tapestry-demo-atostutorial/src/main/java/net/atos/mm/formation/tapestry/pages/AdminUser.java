...
//		_model = _beanModelSource.createDisplayModel(User.class, _resources);
//		_model = _beanModelSource.createEditModel(User.class, _resources);
	...
	@OnEvent(value="action", component="deleteUser")
	public void removeUser(String login) {
		manager.removeUser(login);
	}

	@OnEvent(value="action", component="editUser")
